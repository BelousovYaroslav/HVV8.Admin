 ...
 * @author yaroslav
 */
public class TechProcessStep08p5MaxWatchdog implements Runnable {
    static Logger logger = Logger.getLogger( TechProcessStep08p5MaxWatchdog.class);
    
    private double m_dblP5max;
    public double GetP5Max() { return m_dblP5max; }
    
    final private HVV_Admin theApp;
    public TechProcessStep08p5MaxWatchdog( HVV_Admin app) {
        theApp = app;
        m_dblP5max = 0.;
    }
