...
public class TechProcessStep10_1_Dlg_A extends javax.swing.JDialog {
    ...
    public void LoadProgram() {
        ...
        switch( m_nProgramType) {
            ...
            case 21:
                ...
                m_pnlSteps.edtDuration.setText( "5");
                m_pnlSteps.edtPower.setText( "43");
            break;
    ...
    private void scrlBarAdjustmentValueChanged(java.awt.event.AdjustmentEvent evt) {//GEN-FIRST:event_scrlBarAdjustmentValueChanged

        if( m_pnlSteps != null)
            m_pnlSteps.setBounds( 0, 0 - scrlBar.getValue(), 400, 440 + scrlBar.getValue());
        
    }//GEN-LAST:event_scrlBarAdjustmentValueChanged

    private void pnlInductorStepsMouseWheelMoved(java.awt.event.MouseWheelEvent evt) {//GEN-FIRST:event_pnlInductorStepsMouseWheelMoved
    ...
    }//GEN-LAST:event_pnlInductorStepsMouseWheelMoved
