 ...
 * @author yaroslav
 */
public class TechProcessStep10_1_Dlg_M extends javax.swing.JDialog {
    ...
    static Logger logger = Logger.getLogger(TechProcessStep10_1_Dlg_M.class);
    final private HVV_Admin theApp;
    
    TechProcessStep10_1_Dlg_A m_dlgInd1 = null;
    TechProcessStep10_1_Dlg_A m_dlgInd2 = null;
    
    public P5PollerRunnable m_p5PollerRunnable;
    public Thread m_p5PollerThread;
    
    TechProcessStep10_1_Dlg_M_HalfPanel m_pnlDevices14;
    TechProcessStep10_1_Dlg_M_HalfPanel m_pnlDevices58;
    ...
    class DelayedStartOfADlgs implements ActionListener {
        ...
        private final TechProcessStep10_1_Dlg_M m_pParent;
        private final int m_nInductor;
                
        public DelayedStartOfADlgs( TechProcessStep10_1_Dlg_M pParent, int nInductor) {
            m_pParent = pParent;
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            TechProcessStep10_1_Dlg_A pChild;
            if( m_nInductor == HVV_AdminConstants.INDUCTOR1) {
                m_pParent.m_dlgInd1 = new TechProcessStep10_1_Dlg_A( theApp, new javax.swing.JFrame(), false, m_nInductor, m_pParent);
                pChild = m_pParent.m_dlgInd1;
            }
            else {
                m_pParent.m_dlgInd2 = new TechProcessStep10_1_Dlg_A( theApp, new javax.swing.JFrame(), false, m_nInductor, m_pParent);
     ...
     */
    public TechProcessStep10_1_Dlg_M( HVV_Admin app, java.awt.Frame parent, boolean modal) {
        super( parent, modal);
        ...
        */
        ...
        m_pnlDevices14 = new TechProcessStep10_1_Dlg_M_HalfPanel( app, HVV_AdminConstants.DEVICE1);
        ...
        m_pnlDevices58 = new TechProcessStep10_1_Dlg_M_HalfPanel( app, HVV_AdminConstants.DEVICE5);
    ...
    private void initComponents() {
        ...
        setTitle("10.1 Активация рабочих геттеров");
        setMaximumSize(new java.awt.Dimension(1020, 1025));
        setMinimumSize(new java.awt.Dimension(1020, 1025));
        setPreferredSize(new java.awt.Dimension(1020, 1025));
        setResizable(false);
    ...
    private void btnNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextActionPerformed
        ...
        //отмечаем 10.1 этап
        TechProcessStepInfo info = ( TechProcessStepInfo) theApp.GetStepInfo( "181");
        ...
        if( theApp.m_pMainWnd.m_pPanel.pnlStep10.chk_10_02_AutoStart != null &&
                theApp.m_pMainWnd.m_pPanel.pnlStep10.chk_10_02_AutoStart.isSelected()) {
            ...
            StartProgramExecutor executor = new StartProgramExecutor( theApp, "AdminStep_" + theApp.HumanNameForStep( "182") + ".xml");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TechProcessStep10_1_Dlg_M.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                TechProcessStep10_1_Dlg_M dialog = new TechProcessStep10_1_Dlg_M( null, new javax.swing.JFrame(), false);
                ...
                TechProcessStep10_1_Dlg_A dialog2 = new TechProcessStep10_1_Dlg_A( null, new javax.swing.JFrame(), false, HVV_AdminConstants.INDUCTOR2, dialog);
                /*dialog.addWindowListener(new java.awt.event.WindowAdapter() {
                    @Override
                    public void windowClosing(java.awt.event.WindowEvent e) {
                        System.exit(0);
                ...
                TechProcessStep10_1_Dlg_A dialog1 = new TechProcessStep10_1_Dlg_A( null, new javax.swing.JFrame(), false, HVV_AdminConstants.INDUCTOR1, dialog);
                /*dialog.addWindowListener(new java.awt.event.WindowAdapter() {
                    @Override
                    public void windowClosing(java.awt.event.WindowEvent e) {
                        System.exit(0);
