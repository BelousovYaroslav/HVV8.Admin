...
import obsolete.TechProcessPanel4;
import java.io.File;
 ...
 * @author yaroslav
 */
public class TestDialog4 extends javax.swing.JDialog {

    TechProcessPanel4 m_pPanel;
     ...
     */
    public TestDialog4(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        m_pPanel = new TechProcessPanel4( this);
        m_pPanel.setVisible( true);
        pnlPanel.add( m_pPanel);
        
        m_pPanel.setBounds( 2, 2, 800, 400);
    ...
    private void initComponents() {
        ...
        pnlPanel.setBounds(10, 40, 804, 404);
        ...
        jButton1.setBounds(740, 460, 72, 34);
        ...
        jScrollBar1.setBounds(820, 40, 20, 410);
    ...
    private void jScrollBar1AdjustmentValueChanged(java.awt.event.AdjustmentEvent evt) {//GEN-FIRST:event_jScrollBar1AdjustmentValueChanged
        m_pPanel.setBounds( 2, 2 - jScrollBar1.getValue(), 800, 400 + jScrollBar1.getValue());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TestDialog4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TestDialog4 dialog = new TestDialog4(new javax.swing.JFrame(), true);
